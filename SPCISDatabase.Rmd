...
## where n >1 and unique_year >1 ==> resampled plots. Change their plot IDs to have a single id across years. For  >1 and unique_year = 1, Jeff will confirm what to do.
```
