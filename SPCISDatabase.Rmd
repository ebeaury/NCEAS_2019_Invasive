...
```{r}
NWCA <- read.csv("/home/shares/neon-inv/data_paper/data_by_dataset/NWCA2011-2016_04212022.csv", 
                  na = c('', 'NA')) 
glimpse(NWCA)
```
...
FULLDatabase_04182022 <- read_csv("final_data/archived/FULLDatabase_04182022.csv")
...
SPCIS_plots <- SPCISDatabase %>% 
  select(Plot, Year, Original.Plot, Site, Original.Site, Long, Lat, FuzzedCoord, Zone, PlotArea.m2, SamplingMethod, Resampled) %>%
...
ggsave("/home/shares/neon-inv/data_paper/figures/GraphInvadedPlotsperDataset04182022.png", dpi=300)
```
...
png('/home/shares/neon-inv/data_paper/figures/ecoregionsNN/graphcombinedIntroduced04182022.png', width = 1920,height = 1080)
print(all)
dev.off()
...
png('/home/shares/neon-inv/data_paper/figures/ecoregionsN/graphcombinedNat4182022.png', width = 1920,height = 1080)
print(all)
dev.off()
