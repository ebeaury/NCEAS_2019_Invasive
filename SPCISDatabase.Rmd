...
AIM <- AIM  %>%
  ...
  mutate(PctCov = 100*prop.cover,
         FuzzedCoord = "N",
         Site = NA,
         PlotArea.m2 = ifelse(DataSet == "BLM_LMF", 2827, 10000),
         Dataset = "AIM",
...
```{r}
IL_CTAP <- read.csv("/home/shares/neon-inv/data_paper/data_by_dataset/IL_CTAP_DataPaper05202022.csv", 
                 na = c('', 'NA')) 
glimpse(IL_CTAP)
```
...
```{r eval=FALSE, include=FALSE}
write_rds(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_05202122.rds")
write_csv(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_05202122.csv")
```
