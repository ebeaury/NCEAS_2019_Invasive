...
```{r eval=FALSE, include=FALSE}
write_rds(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_04132022.rds")
write_csv(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_04132022.csv")
```
...
```{r}
#plant data
write_rds(SPCIS_plant_taxa, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plant_taxa_0413022.rds")
write_csv(SPCIS_plant_taxa, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plant_taxa_04132022.csv")

#plot data
write_rds(SPCIS_plots, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plots_0413022.rds")
write_csv(SPCIS_plots, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plots_04132022.csv")
```
...
ggsave("/home/shares/neon-inv/data_paper/figures/GraphInvadedPlotsperDataset04132022.png", dpi=300)
```
...
png('/home/shares/neon-inv/data_paper/figures/ecoregionsNN/graphcomginedNN04132022.png', width = 1920,height = 1080)
print(all)
dev.off()
...
png('/home/shares/neon-inv/data_paper/figures/ecoregionsN/graphcomginedNat4132022.png', width = 1920,height = 1080)
print(all)
dev.off()
