...
# these duplicates are already present in the orginal datasets, assuming the ones who Id them that each entry is a different morphotype, and potentially a distinct species
```
...
DataBase <- DataBase %>%
  mutate(Original.PctCov = PctCov,
         PctCov = PctCov/SampledArea,
         Original.SampledArea = SampledArea,
         SampledArea = 1)
...
```{r eval=FALSE, include=FALSE}
write_rds(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_01312022.rds")
write_csv(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_01312022.csv")
```
...
```{r eval=FALSE, include=FALSE}
write_rds(SPCISDatabase, "/home/shares/neon-inv/data_paper/final_data/SPCISDatabase_01312022.rds")
write_csv(SPCISDatabase, "/home/shares/neon-inv/data_paper/final_data/SPCISDatabase_01312022.csv")
```
