...
VNHPresample <- VNHP %>% 
  ...
  filter(unique_year>1,
         !grepl("^GRAF", Plot)) %>% 
  mutate(NewPlotID = ifelse(str_detect(Plot, "R$") | str_detect(Plot, "P$") |
                              str_detect(Plot, "D$") | str_detect(Plot, "S$"), str_sub(Plot, 1,-2), Plot)) %>% 
  ungroup() %>%
...
### ?? Not sure what to do with Composite --> asked Jeff, waiting his reply [PWFP016, PWFP016C ==> same year of data sampling]
```
...
```{r eval=FALSE, include=FALSE}
write_rds(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_02282022.rds")
write_csv(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_02282022.csv")
```
...
```{r eval=FALSE, include=FALSE}
write_rds(SPCISDatabase, "/home/shares/neon-inv/data_paper/final_data/SPCISDatabase_02282022.rds")
write_csv(SPCISDatabase, "/home/shares/neon-inv/data_paper/final_data/SPCISDatabase_02282022.csv")
```
