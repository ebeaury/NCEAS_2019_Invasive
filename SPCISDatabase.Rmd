...
FULLDatabase_04182022 <- read_csv("/home/shares/neon-inv/data_paper/final_data/archived/FULLDatabase_04202122.csv")
...
#NPS has 5761 less observations 
#WNHP has 1917 less observations

## Besides NWCA, the discrepancy on the number of obs is because the filter of pctcov >0 happens a few chunks below. Those extra observations are due to pctcover == 0
## and I have recently removed duplicated plots between VNHP and NPS, NWCA and WVNHP
...
DataBase %>% 
  ...
  cbind(x) %>% 
  mutate(n = n...2-n...4)
# all datasets have the same number of plots, besides NWCA and NPS. This is due to recelty removed duplicated plots
...
DataBase %>% filter(PctCov > 100) %>% nrow() # 974 observations in which PctCover for a taxon per plot is >100%
...
```{r echo=TRUE}
write_rds(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_05232022.rds")
write_csv(FULLDatabase, "/home/shares/neon-inv/data_paper/final_data/FULLDatabase_05232022.csv")
```
...
DesiredColumns2 <- c("Dataset", "Site", "Original.Site",
                    ...
                    "PctCov", "RelCov", "RecordedStrata", "PlotArea.m2", "SamplingMethod", "Resampled"
                    )
...
SPCIS_plant_taxa <- SPCISDatabase %>% 
  select(Plot, Year, SpCode, AcceptedTaxonName, Original.TaxonName, 
         NativeStatus, Duration, GrowthHabit, PctCov, RelCov, RecordedStrata) %>% 
  as_tibble()
...
```{r echo=TRUE}
#plant data
write_rds(SPCIS_plant_taxa, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plant_taxa_05232022.rds")
write_csv(SPCIS_plant_taxa, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plant_taxa_05232022.csv")

#plot data
write_rds(SPCIS_plots, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plots_05232022.rds")
write_csv(SPCIS_plots, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plots_05232022.csv")
```
...
write_rds(SPCIS_plotsEco, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plotsEco_05232022.rds")
write_csv(SPCIS_plotsEco, "/home/shares/neon-inv/data_paper/final_data/SPCIS_plotsEco_05232022.csv")
```
...
#Full database with ecoregion level 1
write_rds(FULLDatabaseEco, "/home/shares/neon-inv/data_paper/final_data/FULLDatabaseEco_05232022.rds")
write_csv(FULLDatabaseEco, "/home/shares/neon-inv/data_paper/final_data/FULLDatabaseEco_05232022.csv")
```
...
png('/home/shares/neon-inv/data_paper/figures/ecoregionsNN/graphcombinedIntroduced05232022.png', width = 1920,height = 1080)
print(all)
dev.off()
