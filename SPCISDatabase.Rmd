...
```{r}
IL_CTAP <- read.csv("/home/shares/neon-inv/data_paper/data_by_dataset/IL_CTAP_DataPaper05262022.csv", 
                 na = c('', 'NA')) 
glimpse(IL_CTAP)
```
...
#### FIX: add here code to join column Pct_100 by SpCode.Original and then remove SpCode.Original
##### IL_CTAP already carries this information from the data
