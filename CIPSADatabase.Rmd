...
tax <- tax %>% separate(Scientific.Name, c("genus", "epithet"), remove = F)
```
...
FIA2_fixed <- FIA2 %>% 
  ...
  select(VEG_SPCD, Zone, NativeStatus, bestname, genus, epithet, Duration, Growth.Habit)
...
```{r eval=FALSE, include=FALSE}
write_rds(CIPSADatabase, "/home/shares/neon-inv/data_paper/final_data/CIPSADatabase_12232021.rds")
write_csv(CIPSADatabase, "/home/shares/neon-inv/data_paper/final_data/CIPSADatabase_12232021.csv")
```
