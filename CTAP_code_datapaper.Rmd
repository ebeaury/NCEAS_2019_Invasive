...
IL_CTAP <- forestfinal %>% 
  ...
  group_by(Dataset, SiteID, Transect, PYear, OriginalSpeciesName, 
           layer, RecordedStrata, SampledArea) %>% 
...
```{r}
IL_CTAP2 %>% write.csv(file.path(data_output, "IL_CTAP_DataPaper02242022.csv"))
```
